...
public:
  ...
  // Copy assignment
  inline QueueLst operator=(const QueueLst & that) {(List<Data>)(*this) = (List<Data>)(that); return *this;}

  // Move assignment
  inline QueueLst operator=(QueueLst && that) {(List<Data>)(*this) = std::move((List<Data>)(that)); return *this;}
